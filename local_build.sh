...
echo  --buildroot $BUILD_ROOT --define="_topdir $TOP_DIR" --define="_sourcedir $SOURCE_DIR" --define="_rpmdir $TARGET" --define="version $RPM_VERSION" --noclean -bb ./bashtester.spec 
